...
public class Assignment2_EditLead {
	...
	public static void main(String[] args) {
		...
		//16. Click on Editlead
		driver.findElement(By.linkText("Edit")).click();
		
		 //17.clear the description field
		driver.findElement(By.id("updateLeadForm_description")).clear();
					
		//18.Fill the important note field
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Advanced program trainer");
		
		//19.Click on update 
		driver.findElement(By.className("smallSubmit")).click();
		
		//20. get current page title
